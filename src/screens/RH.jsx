...
import {
  useAllWarnings, useAllVacations, useAllDocuments,
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minHeight: 0, overflowY: 'auto' }}>
        ...
        {tab === 'beneficios' && <BeneficiosTab {...shared} />}
...
// ============================================================
// ABA — BENEFÍCIOS (shell)
// ============================================================
function BeneficiosTab({ activeEmployees }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div className="row" style={{ gap: 12, flexWrap: 'wrap' }}>
        <p style={{ margin: 0, fontSize: 13, color: 'var(--muted)', flex: 1 }}>
          Gestão de benefícios e vantagens por funcionário.
        </p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 10 }}>
        {BENEFIT_TYPES.map(b => (
          <div key={b} className="card" style={{ padding: '12px 14px', opacity: 0.5 }}>
            <div style={{ fontSize: 11, color: 'var(--muted)', fontWeight: 600, marginBottom: 6 }}>{b}</div>
            <div className="mono" style={{ fontSize: 22, fontWeight: 700 }}>—</div>
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
        <div style={{ padding: '10px 16px', borderBottom: '1px solid var(--line)', display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontSize: 11.5, color: 'var(--muted)', background: 'var(--info-bg)', color: 'var(--info)', borderRadius: 20, padding: '2px 10px', fontWeight: 600 }}>Em desenvolvimento</span>
        </div>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, opacity: 0.45 }}>
          <thead>
            <tr style={{ background: 'var(--surface-2)', color: 'var(--muted)', fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.6 }}>
              ...
              <th style={{ textAlign: 'left', padding: '9px 16px', fontWeight: 600 }}>Valor</th>
              <th style={{ textAlign: 'left', padding: '9px 16px', fontWeight: 600 }}>Vigência</th>
              <th style={{ textAlign: 'left', padding: '9px 16px', fontWeight: 600 }}>Status</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td colSpan={5} style={{ padding: '40px 16px', textAlign: 'center', color: 'var(--muted)', fontSize: 13 }}>
                <Icon name="gift" size={28} style={{ opacity: 0.2, marginBottom: 10, display: 'block', margin: '0 auto 10px' }} />
